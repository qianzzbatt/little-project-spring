...
public class LoginProducerConfiguration {
     ...
     * 日志管理组件
     */
    private static final Logger LOGGER = LoggerFactory.getLogger(LoginProducerConfiguration.class);
    ...
    public LoginProducerConfiguration(String producerGroupName, String nameServerAddr) {
